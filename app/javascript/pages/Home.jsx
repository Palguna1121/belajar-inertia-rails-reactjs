      ...
      <div className="relative overflow-hidden bg-white dark:bg-gray-900 dark:text-gray-100">
        ...
        <header id="page-header" className="relative flex flex-none items-center py-8">
          ...
          <div className="container mx-auto flex flex-col gap-4 px-4 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-0 lg:px-8 xl:max-w-7xl">
            <div>
              <Link href="#" className="group inline-flex items-center gap-2 text-lg font-bold tracking-wide text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300">
                <svg
            ...
            <nav className="space-x-3 md:space-x-6">
              <Link href="#" className="text-sm font-semibold text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400">
                <span>Features</span>
              </Link>
              <Link href="#" className="text-sm font-semibold text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400">
                <span>Pricing</span>
        ...
        <div className="container relative mx-auto px-4 py-16 lg:px-8 lg:py-32 xl:max-w-7xl">
          <div className="text-center">
            <div className="mb-2 inline-flex rounded border border-gray-200 bg-gray-100 px-2 py-1 text-sm font-medium leading-4 text-gray-800 dark:border-gray-600/50 dark:bg-gray-700/50 dark:text-gray-200">v6.0 Latest Version</div>
            ...
            <h2 className="mx-auto text-xl font-medium leading-relaxed text-gray-700 lg:w-2/3 dark:text-gray-300">Super fast and easy to use software to power your next idea or build your client’s web projects. Get it today and profit.</h2>
          </div>
          <div className="flex flex-col gap-2 pb-28 pt-10 sm:flex-row sm:items-center sm:justify-center">
            ...
            >
              <svg className="hi-mini hi-arrow-down-tray inline-block size-5 opacity-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <div className="relative mx-5 lg:mx-32">
            ...
            <img src="https://cdn.tailkit.com/media/placeholders/photo-1SAnrIxw5OY-1280x800.jpg" className="relative mx-auto rounded-lg shadow-lg" alt="Hero Image" />
          </div>
        </div>
        {/* END Hero Content */}
      </div>
